    ...
    <section id="contact" className={"footer" + (compact ? " compact" : "")} data-screen-label="Footer">
      <div className="wrap">
        ...
        <div className="footer-card footer-contact reveal">
          ...
          <div className="office">{lang === "en" ? "FINE Auditing Limited Liability Company" : "Công ty TNHH Kiểm toán FINE"}</div>
          ...
          <ul className="footer-info-list">
            <li>
              ...
              <span><strong>{lang === "en" ? "Office:" : "Văn phòng:"}</strong> 14 Truong Quyen, Xuan Hoa Ward, Ho Chi Minh City, Vietnam
